...
from gas.data import get_clip_data, get_context, get_classes, load_first_screen, get_photos_classes, set_finding
...
path_classes = path_data + ("sea_result.csv" if sea_database else "v3c_result.csv")
path_selection = path_data + ("sea_selection.txt" if sea_database else "")
...
finding = set_finding(sea_database, size_dataset, path_selection)
